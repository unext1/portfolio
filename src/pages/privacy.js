...
const IndexPage = () => (
  <Layout>
    <SEO id="Privacy Policy" title="privacy" keywords={['gatsby', 'website', 'react', 'portfolio']} />
    ...
    <div className="container" id="privacy">
      ...
      <p>LvPortfolio uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside Sweden and choose to provide information to us, please note that we transfer the
        data, including Personal Data, to Sweden and process it there.
      </p>
      <p>
      ...
      <p>
        LvPortfolio will take all steps reasonably necessary to ensure that your data is treated securely and in
      ...
      <p>LvPortfolio may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of LvPortfolio</li>
      ...
      <ul>
        <li>By email: unext1477@gmail.com</li>
        <li>By visiting this page on our website: https://lvportfolio.netlify.com/#contact</li>
      </ul>
    </div>
  </Layout>
);
